...
const Color lightBackroundBottomNavigationBarColor =
...
const Color darkBackroundBottomNavigationBarColor =
...
Color green = const Color(0xff36C361);
Color softGreen = const Color(0xffDDFFE7);

// ----------------------------------- DataColumn TextStyle ----------------------------------------
TextStyle datacolumnText = const TextStyle(
